            ...
            else
            {
                ...
                if (sucursal.Id_Archivo== 0)
                {
                    try
                    {
                        ...
                        //var pruebas=db.ArchivosOrganigrama.FirstOrDefault(x => x.Em_Cve_Empresa ==sucursal.Em_Cve_Empresa);
                ...
                else
                {
                    try
                    {
                        ...
                        //Sucursal sucur = db.Sucursal.Find(sucursal.Em_Cve_Empresa);
                        sucur.Ruta = "/Upload/Empresa/" + sucursal.Ruta;
                        //sucur.Sc_Descripcion = sucursal.Sc_Descripcion;
                        //sucur.Ceco_Cve_Ceco = sucursal.Ceco_Cve_Ceco;
                        //sucur.Sc_Direccion = sucursal.Sc_Direccion;
