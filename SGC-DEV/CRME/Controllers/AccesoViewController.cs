...
namespace CRME.Controllers
{
    public class AccesoViewController : Controller
    {
        ...
        public async Task<ActionResult> Ingresar(LoginViewModel login, string ReturnUrl )
        {
            ...
            cat_sistemas usuario = db.cat_sistemas.FirstOrDefault(x => x.correo == login.Usuario);
            ...
            if(result == false && usuario != null)
            {
                if(usuario.estatus_ID == 2)
                {
                    ModelState.AddModelError("Password", "El correo esta inactivo.");
                }
            ...
            if (usuario == null)
            {
                ModelState.AddModelError("Password", "El correo o contraseña son incorrectos.");
            }
        ...
        public bool SendMail(cat_sistemas usuario)
        {
            ...
            msg.Subject = "Restablecimiento de contraseña de la cuenta en SGC";
        ...
        public ActionResult Recuperar(LoginViewModel login)
        {
            ...
            if (!string.IsNullOrEmpty(correo))
            {
                ...
                usuarios = db.cat_sistemas.FirstOrDefault(x => x.correo == correo);
            }
            ...
            try
            {
                ...
                if (usuario != null)
                {
                    ...
                    if (diferencia.Hours < 24 && diferencia.Days < 1)
                    {
                        ...
                        ViewBag.usuario = usuario.correo;
